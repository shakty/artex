 ...
 *
 * This class packages the 11-dimensional vector of numbers 
 * from 0 through 1 that completely describe a Chernoff face.  
 *
 */
...
//                 // Add a different element according to 
...
//                 
//                 if (attributes.label) {
//                     node.window.addLabel(container, elem, 
//                                          null, attributes.label);
//                 }
//                 
    ...
    for (var key in this.features) {    
        if (this.features.hasOwnProperty(key)) {
            ...
            if (el) {
                ...
                //           }
                //           
                //           // var values = d2xy(value, 
                //           // CFControls.others.mouth_top_y,
                //           // CFControls.others.mouth_bottom_y);
                //
                //           out['mouth_top_y'] = x;
